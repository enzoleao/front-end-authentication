...
export default function Tablergs(){
  ...
  const [listRgs, setListRgs] = React.useState();
      ...
      const handleEditSubmit = () => {
        Axios.put("http://191.101.78.120:3001/atualizarrg",{
          values
        }).then((response)=>{
      ...
      const deletarRg = ()=>{
        Axios.delete(`http://191.101.78.120:3001/apagaridregistrado/${values.id}`)
        .then((res)=>{
    ...
    React.useEffect(()=>{
        Axios.get("http://191.101.78.120:3001/getallrgs")
        .then((response)=>{
